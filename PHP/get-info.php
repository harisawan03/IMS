...
if ($inventory["item"] == "") {
    ...
    echo '<form method="post" action="/PHP/add.php">
        ...
        Amount being added<br><input type="number" name="amount" min="1" step="1" value="1" required><br><br>
        <div id="readonly">
            Item Name<br><input type="text" name="item" value="'.$inventory["item"].'" required readonly style="background-color: #999;"><br><br>
            Category<br>
            <select class="select" name="category" required readonly style="background-color: #999;">
            ...
            Bin<br><input type="number" name="bin" min="1" step="1" value="'.$inventory["bin"].'" required readonly style="background-color: #999;"><br><br>
            <!-- Description<br><input type="text" name="description"><br><br> -->
        </div>
        </div>
        <div id="add"></div>
